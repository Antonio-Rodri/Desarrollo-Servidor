<x-layouts::auth>
    <div class="flex flex-col gap-6">
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            ...
            <flux:input name="especialidad" :label="__('Especialidad')" :value="old('especialidad')" type="text"
                required autofocus autocomplete="especialidad" :placeholder="__('Especialidad')" />
