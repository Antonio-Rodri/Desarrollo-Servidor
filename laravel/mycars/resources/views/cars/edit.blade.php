<x-layouts::app :title="__('Modificar coche')">
        ...
        <form action="{{ route('cars.update', $car->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="matricula" id="matricula"
                    ...
                    placeholder=" " required value="{{ old('matricula', $car->matricula) }}" />
                <label for="matricula"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="marca" id="marca"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required value="{{ old('marca', $car->marca) }}" />
                <label for="marca"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="modelo" id="modelo"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required value="{{ old('modelo', $car->modelo) }}" />
                <label for="modelo"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="color" id="color"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required value="{{ old('color', $car->color) }}" />
                    <label for="color"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="year" id="year"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required value="{{ old('year', $car->year) }}" />
                    <label for="year"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="date" name="fecha_ultima_revision" id="fecha_ultima_revision"
                        ...
                        value="{{ old('fecha_ultima_revision', $car->fecha_ultima_revision) }}" />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="number" name="precio" id="precio"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required value="{{ old('precio', $car->precio) }}" />
                    <label for="precio"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <img src="{{ asset($url . $car->foto) }}" alt="Foto del coche" class="w-10 h-10 object-cover">
                <input type="file" name="foto" id="foto"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " value="{{ old('foto', $car->foto) }}" />
                <label for="foto"
